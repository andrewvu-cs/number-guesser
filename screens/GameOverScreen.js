        ...
        <View style={styles.screen}>
          ...
          <View style={styles.resultContainer}>
            <BodyText style={styles.resultText}>
              ...
              to guess the number
              <Text style={styles.highlight}> {props.userNumber}</Text>! You
              guessed out of bounds{" "}
...
// react native cannot tell the dimensions of a network image therefore you need to set width and height to 100
